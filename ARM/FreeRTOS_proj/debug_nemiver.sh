...
arm-none-eabi-gdb --batch --command=init.gdb bin/$PROJECT.axf

# start the gdb gui
nemiver --remote=localhost:3333 --gdb-binary="$(which arm-none-eabi-gdb)" bin/$PROJECT.axf
